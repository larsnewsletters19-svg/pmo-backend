...
def health():
    ...
    try:
        supabase_url = "https://zcdjwtyxehfrkyhnpekq.supabase.co/rest/v1/projects"
        supabase_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpjZGp3dHl4ZWhmcmt5aG5wZWtxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjUxOTEyNDYsImV4cCI6MjA4MDc2NzI0Nn0.Pg0etjmcDrgE30R0ERXpESxfAGyxhR2cqMnCGArEn9o"
        
        response = requests.get(
            f"{supabase_url}?select=id&limit=1",
            headers={
                'apikey': supabase_key,
        ...
        health_status['supabase_ping'] = 'ok' if response.status_code == 200 else 'failed'
